...
eval_df = pd.read_csv(os.path.join(root_dir,"xquad-thai-eval.csv"))


parser = argparse.ArgumentParser()
parser.add_argument("-m","--model", help="HuggingFace model id",default="aisingapore/llama3-8b-cpt-sea-lionv2-instruct")
